...
# packages go here
install.packages(c('dash', 'readr', 'here', 'ggthemes', 'remotes', 'tidyr', 'plotly', 'dplyr', 'rlang','maps','dashTable','stringr','scales','rlang','purrr','dashHtmlComponents','dashCoreComponents'))
